...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__he0f760a263d54029: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h2e56ba68a6293363: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h41a7e45fd73355e2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h41a7e45fd73355e2_2: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hd8bd8dbcf8456cb8: (a: number, b: number) => void;
